      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-9 backdrop-blur-xl">
          <div className="grid grid-cols-2 gap-3 mb-5">
            <button className="flex items-center justify-center gap-2 py-3 bg-black/30 border border-white/10 rounded-lg text-sm text-gray-400 hover:border-accent-violet/30 hover:text-white transition-all" onClick={loginWithGoogle}>
            ...
            <button className="flex items-center justify-center gap-2 py-3 bg-black/30 border border-white/10 rounded-lg text-sm text-gray-400 hover:border-accent-violet/30 hover:text-white transition-all" onClick={loginWithGitHub}>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-gray-400 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 accent-accent-violet" />
                Lembrar de mim
              </label>
              <a href="#" className="text-accent-violet font-medium hover:underline">Esqueceu a senha?</a>
            </div>
          ...
          <div className="text-center mt-6 text-sm text-gray-400">
            Não tem uma conta? <Link to="/register" className="text-accent-violet font-semibold hover:underline">Criar conta</Link>
          </div>
        </div>
      </div>
    </div>
